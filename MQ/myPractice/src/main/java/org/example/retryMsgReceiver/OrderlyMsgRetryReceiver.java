...
public class OrderlyMsgRetryReceiver {
    ...
    public static void main(String[] args) throws MQClientException {
        ...
        defaultMQPushConsumer.setSuspendCurrentQueueTimeMillis(3000);
        // todo 对于顺序消息来说，该字段可以设置顺序消息消费失败重试的最大值，默认顺序消费的最大值 java 中 int 的最大值
        defaultMQPushConsumer.setMaxReconsumeTimes(1000);
